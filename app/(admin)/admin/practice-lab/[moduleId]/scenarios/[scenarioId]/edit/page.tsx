...
export default function EditScenarioPage() {
  ...
  if (moduleId !== 'client-interview' || moduleType !== 'CLIENT_INTERVIEW') {
    return (
      <AdminLayout title="Edit scenario" breadcrumb={`Home / Practice Lab / ${meta.title}`}>
        <div className="card">
          <div className="card-body text-center py-6">
            <p className="text-body-secondary mb-4">
              Editing is only available for <strong>Client Interview</strong> scenarios.
            </p>
  ...
  return (
    <AdminLayout
      title="Edit scenario"
      breadcrumb={`Home / Practice Lab / ${meta.title} / Edit`}
    >
      <div className="mb-4">
